...
const amazonProtocol = (dom) => {
  ...
  var price = domByID("priceblock_ourprice")
    ...
    : domByID("priceblock_dealprice") ? domByID("priceblock_dealprice").innerHTML : "";
  var title = domInner("title")[0];
  const description = domByID("feature-bullets") ? domByID("feature-bullets")
    ...
    .replace(/(\r\n|\n|\r)/gm, "") : "";
  const image = domByID("landingImage") ? domByID("landingImage").getAttribute("data-old-hires") : "https://i1.wp.com/fremontgurdwara.org/wp-content/uploads/2020/06/no-image-icon-2.png"
