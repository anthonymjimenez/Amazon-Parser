...
const url=["https://www.amazon.com/Fire-TV-Stick-4K-with-Alexa-Voice-Remote/dp/B079QHML21/ref=gbps_img_s-5_cd34_0d56241e?smid=ATVPDKIKX0DER&pf_rd_p=fd51d8cf-b5df-4144-8086-80096db8cd34&pf_rd_s=slot-5&pf_rd_t=701&pf_rd_i=gb_main&pf_rd_m=ATVPDKIKX0DER&pf_rd_r=4MRB3MB8YTD1TJ7ZRG23", 'https://www.amazon.com/Xbox-Gift-Card-Digital-Code/dp/B00F4CEHNK/ref=zg_bs_videogames_home_2?_encoding=UTF8&psc=1&refRID=1AXP2J3GBVG6CMM6VVRY']
...
const amazonProtocol = (dom) => {
  ...
  const description = 
    domByID("feature-bullets").getElementsByClassName('a-list-item')[0].innerHTML.concat(` ${domByID("feature-bullets").getElementsByClassName('a-list-item')[1].innerHTML}`).replace(/(\r\n|\n|\r)/gm, "");
